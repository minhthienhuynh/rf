...
@section('content')
    ...
    <section class="main">
        ...
        <div class="page-2-column search-content">
          <div class="searchbox">
            <div class="input-text-wrapper">
              <input class="search-input blog-key-search form-control" type="text" value="{{ request()->q }}" placeholder="Search">
              <div class="close-btn"></div>
            </div>
          </div>
          <div class="page-content"> 
            <h2 class="primary-title text-center title-small"><span class="section-sub-ttl">SEARCH RESULTS</span><span class="main-ttl">Your search for "<b>{{ request()->q }}</b>" didn’t return any results.</span></h2>
