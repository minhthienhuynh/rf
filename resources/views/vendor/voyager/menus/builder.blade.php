            ...
            <div class="modal-content">
                ...
                <form action="" id="m_form" method="POST"
                    ...
                    <div class="modal-body">
                        ...
                        <div>
                            <label for="description">{{ __('voyager::menu_builder.item_description') }}</label>
                            @include('voyager::multilingual.input-hidden', ['_field_name' => 'description', '_field_trans' => ''])
                            <textarea class="form-control" id="m_description" name="description"></textarea><br>
                        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            var $m_modal       = $('#menu_item_modal'),
                ...
                $m_description_i18n = $('#description_i18n'),
            ...
            $m_modal.on('show.bs.modal', function(e, data) {
                ...
                if (_adding) {
                    ...
                    $m_description.val(_src.data('description'));
