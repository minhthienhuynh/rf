...
@section('page_header')
    <h1 class="page-title">
        <i class="voyager-settings"></i> {{ __('voyager::generic.career_settings') }}
    </h1>
@stop
            ...
            <div class="panel">
                ...
                <div class="page-content settings container-fluid">
                    <ul class="nav nav-tabs">
                        @foreach($careerSettings as $group => $settings)
                            <li @if($group == session('career_setting_tab', 'Index')) class="active" @endif>
                    ...
                    <div class="tab-content">
                        @foreach($careerSettings as $group => $settings)
                        <div id="{{ \Illuminate\Support\Str::slug($group) }}" class="tab-pane fade in @if($group == session('career_setting_tab', 'Index')) active @endif">
                            @foreach($settings as $setting)
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    {{ $setting->display_name }} @if(config('voyager.show_dev_tips'))<code>career_setting('{{ $setting->key }}')</code>@endif
                                </h3>
                            </div>
    ...
    <script>
        $('document').ready(function () {
            ...
            $('[data-toggle="tab"]').click(function() {
                $(".career_setting_tab").val($(this).html());
            });
